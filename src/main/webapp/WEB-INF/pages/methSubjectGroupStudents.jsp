			...
			<div id="tabs-1">
				<div class="above-grid" style="text-align: center">
					...
					<button type="button" class="btn btn-primary" data-toggle="modal"
						style="float: right; font-size: 10pt;" data-target="#addDialog">New
						Student</button>
				</div>
				...
				<div class="panel-group" id="accordion">
					<div class="above-grid" style="text-align: center">
						<label>Other Students</label> <a data-toggle="collapse"
							data-parent="#accordion" href="#collapse"><span
							class="glyphicon glyphicon-align-justify" aria-hidden="true"
							style="float: left"></span></a>
					</div>
					<div id="collapse" class="panel-collapse collapse">
						<div class="simple-grid" id="groupOtherStudentsGrid"></div>
					</div>
				</div>
			</div>
			<div id="tabs-2">
...
<script type="text/javascript"
	src="<c:url value="/resources/js/pages/methSubjectGroupStudents.js"/>"></script>
<script type="text/javascript"
	src="<c:url value="/resources/js/pages/methSubjectGroupOtherStudents.js"/>"></script>
<script type="text/javascript"
	src="<c:url value="/resources/js/pages/methSubjectGroupRhythm.js"/>"></script>
